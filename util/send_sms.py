...
def usage():
    ...
    print ("-t target | --target=TARGET_IMSI")
...
opts, args = getopt.getopt(sys.argv[1:],
                           "t:m:r:l:d:", ["target=", "message=", "return=", "log_level=", "subscriber_reg="])
log_level = "DEBUG"
...
reactor.callWhenRunning(client.send_message,target,message,ret)
