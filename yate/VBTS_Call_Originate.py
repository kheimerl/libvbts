...
class YateOriginator:
	...
	def originate(self, args):
		self.ym.originate(self.app, "sip/sip:IMSI460014430422743@127.0.0.1:5062", "101", "external/nodata/VBTS_Call_Provisioning.py")
		#self.app.Yate("call.execute")
		#self.app.params = []
		#self.app.params.append(["callto", "external/nodata/VBTS_Call_Provisioning.py"])
